import 'dart:async';
import 'package:hudddle/SwipeAnimation/data.dart';
import 'package:hudddle/SwipeAnimation/dummyCard.dart';
import 'package:hudddle/SwipeAnimation/activeCard.dart';

//import 'package:hudddle/PageReveal/page_main.dart';
        ...
        body: new Container(
          ...
          child: dataLength > 0
              ...
              : new Text("No Cards Left",
                  style: new TextStyle(color: Colors.teal, fontSize: 50.0)),
        )));
  }
}
